                ...
                <section>
                    <header>
                        ...
                        <p class="mt-1 text-sm text-sky-600">
                            Refine os registros por rua, tipo de evento ou período.
                        </p>
                    </header>

                    <form method="GET" class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                        ...
                        <div class="lg:cols-span-4 flex gap-2">
                            <x-primary-button>
                                Filtrar
                            </x-primary-button>
            ...
            <div class="p-4 sm:p-8 bg-white border border-sky-100 shadow sm:rounded-lg">
                <section>
                    <header>
                        ...
                        <p class="mt-1 text-sm text-sky-600">
                            Linha do tempo dos registros de abastecimento.
                        </p>
                    </header>
                                ...
                                <div class="bg-white border border-sky-100 rounded-lg p-4 shadow-sm">
                                    ...
                                    <div class="mt-2 text-sm text-sky-700">
                                        <p>
                                            ...
                                            {{ $registro->usuario->name ?? 'Anônimo' }}
                                        </p>

                                        @if($registro->nota)
                                            <div
                                                x-data="{ open: false }"
                                                class="mt-1 text-sky-600 text-sm">
                                                <strong>Nota:</strong>

                                                <span
                                                    x-show="!open"
                                                    x-text="@js(Str::limit($registro->nota, 25))"></span>
